<%-- 
    Document   : edithospital
    Created on : 3 Mar, 2022, 3:05:07 PM
    Author     : HP
--%>
		   ...
		   if(rs.getRow()>0)
                   {
                       ...
                       <form class="user" method="get" action="updatehospital.jsp">
                               <div class="form-group">
                                  <input type="hidden" class="form-control form-control-user" value="<%=rs.getString("Sno")  %>" id="exampleInputEmail" name="id"
                                        placeholder="Hospital Name">
                                   <input type="text" class="form-control form-control-user" value="<%=rs.getString("hospitalname")  %>" id="exampleInputEmail" name="hospname"
                                        placeholder="Hospital Name">
                                  </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" value="<%=rs.getString("LicenseNo") %>" id="exampleInputEmail"name="number"
                                        placeholder="License Number">
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control form-control-user" value="<%=rs.getString("Sno") %>" id="exampleInputEmail" name="id"
                                        placeholder="Address">
                                    <input type="Address" class="form-control form-control-user" value="<%=rs.getString("address") %>" id="exampleInputEmail" name="address"
                                        placeholder="Address">
                                </div>
                                ...
                                <div class="form-group">
                                     <input type="hidden" class="form-control form-control-user" value="<%=rs.getString("Sno") %>" id="exampleInputEmail" name="id"
                                        placeholder="Required Cylinder per day">
                                    <input type="number" class="form-control form-control-user" value="<%=rs.getString("cylinderperday") %>" id="exampleInputEmail" name="cylinder"
                                        placeholder="Required Cylinder per day">
                                </div>
                                <div class="form-group">
                                    <input type="hidden" class="form-control form-control-user" value="<%=rs.getString("Sno") %>"id="exampleInputEmail" name="id"
                                        placeholder="Time of Filling">
                                    <input type="time" class="form-control form-control-user" value="<%=rs.getString("timeoffiling") %>"id="exampleInputEmail" name="time"
                                        placeholder="Time of Filling">
                                </div>
